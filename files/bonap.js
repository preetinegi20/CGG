...
// const headerss=document.querySelectorAll(".item");
// const newH=Array.from(headerss)
// let index=1;
// function func(){
//     for(let i=0;i<newH.length;i++)
//     newH[i].style.display="none";
//     if(index>=newH.length-1){
//         index=1;
//     }
//     newH[index].style.display="block"
//     index++;
// }
// setInterval(function(){
//     func();
